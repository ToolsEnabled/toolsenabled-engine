---
name: _template
description: TEMPLATE — copy this folder to create a new capability skill. Not a real power. Describe here exactly WHEN Codex should invoke the skill (the trigger), because Codex selects skills by matching this description to the task.
metadata:
  status: template
  phase: 3
---
